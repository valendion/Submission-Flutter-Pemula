...
TextStyle textTItle = TextStyle(
  fontSize: 16, color: blackPrimaryColor, fontWeight: FontWeight.w500
);

TextStyle textDesc = TextStyle(
    fontSize: 14, color: blackPrimaryColor, fontWeight: FontWeight.w400
);

TextStyle textDesc2 = TextStyle(
    fontSize: 14, color: greyPrimaryColor, fontWeight: FontWeight.w400
);

TextStyle textDesc3 = TextStyle(
    fontSize: 14, color: bluePrimaryColor, fontWeight: FontWeight.w400
);
